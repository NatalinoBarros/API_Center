# API_Center
Esta central de APIs é um serviço em Flask que expõe um endpoint único (/webhook) para receber requisições POST em JSON, validar os dados de entrada e encaminhar a execução para diferentes “serviços” internos com base no campo id.<br>
